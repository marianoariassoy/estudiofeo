    ...
    <>
      <section className="px-16 py-20 pb-10 bg-secondary" id="tienda">
        ...
        <div className="flex gap-4">
          <button className="border-2 border-black rounded-full px-4 py-1 font-bold flex gap-2 hover:opacity-60">
      ...
      <section className="px-16 grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 bg-secondary">
        {data.map((item) => (
